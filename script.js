...
btnAdd.addEventListener("click", ()=>{
  ++contador;
  let tarefa = `
  <div id="${contador}" class="card-tarefa">
    <div class="listItem">${inputItem.value}</div>
    <button class="btnCon" onclick="completar(${contador})">Concluída</button>
    <button class="btnRef" onclick="refazer(${contador})">
      ${svgRef}
    </button>
    <button class="btnRem" onclick="deletar(${contador})">
      ${svgDel}
    </button>
  </div>
  `
...
function completar(id){
  var cardTarefa = document.getElementById(id)
  if (cardTarefa.classList.contains("card-tarefa")){
    cardTarefa.setAttribute("class", "card-tarefa-complete")
  }else{
    cardTarefa.setAttribute("class", "card-tarefa")
  }
}

function refazer(id) {
  var cardTarefa = document.getElementById(id)
  if (cardTarefa.classList.contains("card-tarefa-complete")) {
    cardTarefa.setAttribute("class", "card-tarefa")
  } else {
    cardTarefa.setAttribute("class", "card-tarefa-complete")
  }
